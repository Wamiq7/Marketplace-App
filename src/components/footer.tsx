        ...
        <div className="container max-w-6xl mx-auto text-gray-900">
            <div className="grid grid-cols-3 justify-between">
                ...
                <div className="text-center">
                    <p className="text-gray-600 font-md">Design by<p className="font-lg text-gray-950 font-bold" >M Wamiq Akram</p> </p>
                </div>
                <div className="text-end">
                <p className="text-gray-600 font-md">Code by: <Link className="font-lg text-gray-950 font-bold  " href='https://github.com/Wamiq7/marketplace-app' target="_blank">Wamiq07 on GitHub</Link> </p>
                </div>
            </div>
        </div>
        </div>
